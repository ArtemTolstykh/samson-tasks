...
<?if($arResult["FORM_TYPE"] == "login"):?>
    <span class="hd_singin"><a id="hd_singin_but_open" href="">Войти на сайт</a>
	    <div class="hd_loginform" style="display: block; opacity: 1;">
...
<?if($arResult["NEW_USER_REGISTRATION"] == "Y"):?>
    <noindex><a href="<?=$arResult["AUTH_REGISTER_URL"]?>" class="hd_singup" rel="nofollow"><?=GetMessage("AUTH_REGISTER")?></a></noindex>
<?endif?>
...
<a href="<?=$APPLICATION->getCurPageParam("logout=yes", array(
    ...
    "forgot_password",
    "change_password"))
?>" class="hd_singup"><?=GetMessage("AUTH_LOGOUT_BUTTON")?></a>
